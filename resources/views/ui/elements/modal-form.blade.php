    ...
    <div class="modal-dialog modal-{{ $size }} modal-dialog-centered">
        <div class="modal-content">
            ...
            <div wire:loading.remove wire:target="{{ implode(', ', $loadingTargets) }}" class="modal-header border-0">
                <button type="button" class="btn-close z-1" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div wire:loading.remove wire:target="{{ implode(', ', $loadingTargets) }}" class="modal-body pt-0">
                ...
                <form wire:submit="save" method="POST" novalidate @if($false_submit == true) onSubmit="return false" @endif>
